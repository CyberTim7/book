lexicon_RU = {"start" : "Добро пожаловать в manual_control monitor.\n"  
    "После введенного значения нажмите ENTER\n"
    "Используйте 'help' чтобы получить больше информации.\n\n",
               "user_added" : "Пользователь добавлен.",
               "help" : "\nИспользуйте 'add' чтобы разрешить 1 пользователю пользоваться ботом.\n"
