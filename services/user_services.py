...
async def next_click(book, book_path, callback:CallbackQuery):
    user_id = callback.from_user.id
    with open("C:\\Users\\Lena\\Desktop\\github proects\\book_bot\\database\\SQL.json", "r+") as file:
        data = json.load(file)
    ...
    try:
        ...
        with open("C:\\Users\\Lena\\Desktop\\github proects\\book_bot\\database\\SQL.json", "w") as file:
...
async def down_click(book, book_path, callback:CallbackQuery):
    user_id = callback.from_user.id
    with open("C:\\Users\\Lena\\Desktop\\github proects\\book_bot\\database\\SQL.json", "r+") as file:
        data = json.load(file)
